...
export default function EcommerceLandingPage() {
  ...
  const EMAILJS_CONFIG = {
    serviceId: 'service_iik9j4f',
    templateId: 'template_wel9qrb',
    publicKey: 'eBuyDWxwdXIOPKbBg'
  };
  ...
  // Create a function to get communes by wilaya ID
  const getCommunesByWilaya = (wilayaId) => {
  ...
  const handleWilayaChange = (wilaya) => {
    ...
    setSelectedCommune('');
    setFormData(prev => ({ ...prev, wilaya, commune: '' }));
  };
  ...
  const validateForm = () => {
    ...
    if (!formData.phone.trim()) {
      ...
      newErrors.phone = 'يجب أن يكون رقم الهاتف 10 أرقام';
    }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log('Order submitted:', {
        ...formData,
        totalPrice: productPrice * formData.quantity + deliveryPrice,
        emailSent
      });
    ...
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-orange-50 to-yellow-50">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <div className="flex items-center gap-8">
                <div className="text-4xl font-bold text-gray-900">
                  {productPrice.toLocaleString()} <span className="text-lg text-gray-600">دج</span>
                </div>
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -left-6 w-32 h-32 bg-orange-300 rounded-full opacity-10 animate-pulse delay-1000"></div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-6 rounded-2xl bg-gradient-to-br from-amber-50 to-orange-100 hover:shadow-lg transition-all duration-300">
      ...
      <section className="py-20 px-4 bg-gradient-to-br from-gray-50 to-white">
        <div className="max-w-2xl mx-auto">
          <div className="bg-white rounded-3xl shadow-xl p-8">
            <h2 className="text-3xl font-bold text-center mb-8 text-gray-900">اطلب الآن</h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  >
                    ...
                    {selectedWilaya && getCommunesByWilaya(selectedWilaya).map((commune) => (
              ...
              <div className="bg-gradient-to-r from-amber-50 to-orange-50 rounded-xl p-4 border border-amber-200">
                <div className="flex justify-between items-center mb-2">
                  ...
                  <span className="font-medium">{productPrice.toLocaleString()} دج</span>
                </div>
                <div className="flex justify-between items-center mb-2">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-2xl font-bold text-amber-600">
                    {(productPrice * quantity + deliveryPrice).toLocaleString()} دج
                  </span>
                </div>
              </div>
              ...
              <button
                ...
                className="w-full bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 text-white font-semibold py-4 rounded-xl transition-all duration-300 transform hover:scale-[1.02] disabled:opacity-50 disabled:transform-none flex items-center justify-center gap-2"
              >
                {isSubmitting ? (
                  <div className="flex items-center gap-2">
      ...
      {showSuccessModal && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl p-8 max-w-md w-full animate-pulse">
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-6">
                شكراً لك! سيتم التواصل معك قريباً لتأكيد الطلب وقد تم إرسال تأكيد بالبريد الإلكتروني
              </p>
              <button
                onClick={resetForm}
